...
Orden de ejecucion: columnas/credenciales SUNAT-OSE, resumen fecha, crearOrden/DocumentoVenta.
*/
...
Root cause:
  dbo.uspinsertarNotaBweb still used INSERT INTO DocumentoVenta VALUES (...).
  DocumentoVenta now has extra columns, so crearOrden failed with:
  "El nombre de columna o los valores especificados no corresponden a la definicion de la tabla."

This script replaces the procedure with explicit column lists and keeps the
44-field payload currently produced by NotaController.BuildOrdenPayload.
*/
...
BEGIN
    ...
    BEGIN TRY
        ...
        (
            ...
            EntidadBancaria, NroOperacion, Efectivo, Deposito, ClienteRazon,
            ClienteRuc, ClienteDni, DireccionFiscal, DocuPdfUrl, DocuXmlUrl,
            DocuCdrUrl, DocuFechaPago
        )
        VALUES
        (
