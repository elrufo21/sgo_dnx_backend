/*
  Migración estática: DXN_ICA2209 -> estructura SQL vigente de DXN_ICA.
  Fuente analizada: DXN_ICA, 2026-09-22.
  Alcance: estructura y código SQL. No inserta, actualiza ni elimina datos de negocio.
  Ejecución: abrir en SSMS y ejecutar contra la instancia destino.
*/
USE [DXN_ICA2209];
GO
SET ANSI_NULLS ON;
...
/* Tablas que no existen en DXN_ICA2209. */
...
/* Columnas que existen en DXN_ICA y faltan en DXN_ICA2209. */
...
/* Diferencias de tipo detectadas. Se detiene antes de truncar información. */
...
/* Índices y relaciones agregados en DXN_ICA. */
...
CREATE OR ALTER PROCEDURE [dbo].[CuentaCorrienteCliente]
as
begin
select
...
CREATE OR ALTER PROCEDURE [dbo].[eliminaDetaNota]
@Data varchar(max)
as
begin
declare @p0 int, 
...
CREATE OR ALTER PROCEDURE [dbo].[eliminaGuiaRe]
@GuiaId numeric(38),
@NotaId numeric(38)
as
begin
...
CREATE OR ALTER PROCEDURE [dbo].[eliminarCajaPrin]
@Data varchar(max)
as
begin
Declare @p1 int
...
CREATE OR ALTER PROCEDURE [dbo].[eliminarRenta] 
@Data varchar(max)
as
begin
...
END;
GO
CREATE OR ALTER PROCEDURE [dbo].[ingresarUsuario]
...
CREATE OR ALTER PROCEDURE [dbo].[insertarAlmacen]
@Data varchar(max)
as
begin
Declare @pos1 int
...
CREATE OR ALTER PROCEDURE [dbo].[insertarRenta] 
@Data varchar(max)
as
declare @existe int
...
CREATE OR ALTER PROCEDURE [dbo].[KardeProveedor]
...
CREATE OR ALTER PROCEDURE [dbo].[LDrptCompra]
@Data varchar(max)
as
Declare @p1 int,@p2 int
Declare @fechainicio date,
...
CREATE OR ALTER PROCEDURE [dbo].[LetrasVencidasR]
as
begin
...
CREATE OR ALTER PROCEDURE [dbo].[listaAperturaAlmacen]  
as  
begin  
...
CREATE OR ALTER PROCEDURE [dbo].[listaAperturaFecha]
@fechainicio date,
@fechafin date
as
begin
...
CREATE OR ALTER PROCEDURE [dbo].[listaGeneralFecha] 
...
CREATE OR ALTER PROCEDURE [dbo].[listarUM] 
@IdProducto numeric(20)
as
begin
select
...
CREATE OR ALTER PROCEDURE [dbo].[rptCompraA]
as
begin
...
CREATE OR ALTER PROCEDURE [dbo].[rptCompraComputo] @fechainicio date,@fechafin date,@CompaniaId int
as
begin
select c.CompraId,Convert(char(10),c.CompraEmision,103) as FechaEmision,c.CompraSerie+'-'+c.CompraNumero as Documento,
p.ProveedorRuc as RUC,p.ProveedorRazon as RazonSocial,c.TipoCodigo as TipoCodigo,
...
CREATE OR ALTER PROCEDURE [dbo].[rptCompraEmision] @fechainicio date,@fechafin date,@CompaniaId int
as
begin
select c.CompraId,Convert(char(10),c.CompraEmision,103) as FechaEmision,c.CompraSerie+'-'+c.CompraNumero as Documento,
p.ProveedorRuc as RUC,p.ProveedorRazon as RazonSocial,c.TipoCodigo as TipoCodigo,
...
CREATE OR ALTER PROCEDURE [dbo].[totalLetras] @numero decimal(18,2),@Moneda varchar(60)
as
begin
...
CREATE OR ALTER PROCEDURE [dbo].[uspBuscarApertura]
...
CREATE OR ALTER PROCEDURE [dbo].[uspCantidadLiquidacion]
@NotaId nvarchar(40)
as
begin
declare @count int 
...
CREATE OR ALTER PROCEDURE [dbo].[uspComboDocumentos]
...
CREATE OR ALTER PROCEDURE [dbo].[uspComboGuiasCredito]    
@CodigoRes varchar(80)    
as    
begin    
...
CREATE OR ALTER PROCEDURE [dbo].[uspCorregirKardex]    
@detalle varchar(Max)    
as    
begin    
Begin Transaction    
...
CREATE OR ALTER PROCEDURE [dbo].[uspDetaAperturaB]
@UsuarioID int
as
begin
...
CREATE OR ALTER PROCEDURE [dbo].[uspDetalleApertura]
@IdApertura numeric(38)
as
begin
select
...
CREATE OR ALTER PROCEDURE [dbo].[uspDetaPagoV]
@PagoId varchar(38)
as
begin
select
...
CREATE OR ALTER PROCEDURE [dbo].[uspDeudasDelDia]
@Fecha date
as
begin
select 
...
CREATE OR ALTER PROCEDURE [dbo].[uspEditarLiquidaVenta]
...
CREATE OR ALTER PROCEDURE [dbo].[uspEditarNroTransaccion]
@orden varchar(max)
as
begin
...
CREATE OR ALTER PROCEDURE [dbo].[uspEliminarGuiaLiquida]
@ListaOrden varchar(Max)
as
begin
Declare @pos1 int,@pos2 int
...
CREATE OR ALTER PROCEDURE [dbo].[uspInsertaAutorizacion]
@Data varchar(max)
as
begin
Declare @p1 int,@p2 int,@p3 int,
...
CREATE OR ALTER PROCEDURE [dbo].[uspinsertaLiquidaVenta]
@ListaOrden varchar(Max)
as
begin
Declare @pos1 int,@pos2 int
...
CREATE OR ALTER PROCEDURE [dbo].[uspInsertarApertura]
@ListaOrden varchar(Max)
as
begin
Declare @pos int
...
CREATE OR ALTER PROCEDURE [dbo].[uspInsertarApertutaOBS]
@Data varchar(max)
as
begin
Declare @p1 int,@p2 int,@p3 int,
...
CREATE OR ALTER PROCEDURE [dbo].[uspInsertarCierre]
@ListaOrden varchar(Max)
as
begin
Declare @pos int
...
CREATE OR ALTER PROCEDURE [dbo].[uspInsertarPaginas]
@Data varchar(max)
as
begin
Declare @p1 int,@p2 int,@p3 int,
...
GO
CREATE OR ALTER PROCEDURE [dbo].[uspinsertarRB]
@ListaOrden varchar(Max)
AS
BEGIN
...
CREATE OR ALTER PROCEDURE [dbo].[uspLDPagos]
@Data varchar(max)
as
begin
Declare @p1 int,@p2 int
...
CREATE OR ALTER PROCEDURE [dbo].[uspListaAperturaOBS]
@fechainicio date,
@fechafin date
as
begin
...
CREATE OR ALTER PROCEDURE [dbo].[uspListaAutorizacion]
as
begin
select
...
CREATE OR ALTER PROCEDURE [dbo].[uspListaCreditoGuia]    
as    
begin    
select     
...
CREATE OR ALTER PROCEDURE [dbo].[uspListaFacturaPendiente]
as
begin
select 
...
CREATE OR ALTER PROCEDURE [dbo].[uspListaGuiaLiquidacion]
@fechainicio date,
@fechafin date
as
begin
...
CREATE OR ALTER PROCEDURE [dbo].[usplistaINV]  
as  
begin  
select   
...
CREATE OR ALTER PROCEDURE [dbo].[uspListaPaginas]
as
begin
select
...
CREATE OR ALTER PROCEDURE [dbo].[usplistaPagosVariosP]
@fechainicio date,
@fechafin date
as
begin
...
CREATE OR ALTER PROCEDURE [dbo].[usplistaPersonal]
as
begin
...
CREATE OR ALTER PROCEDURE [dbo].[usplistaPrueba]
as
select
...
CREATE OR ALTER PROCEDURE [dbo].[uspListarApertura]
as
select 
...
CREATE OR ALTER PROCEDURE [dbo].[uspListarArchivos]
@Data varchar(max)
as
begin
Declare @p1 int,@p2 int
...
CREATE OR ALTER PROCEDURE [dbo].[usplistarDetaCaja]
@CajaId numeric(38)
as
begin
select
...
CREATE OR ALTER PROCEDURE [dbo].[uspListaResPorEntregar]
as
begin
select 
'Codigo|Responsable|Saldo¬100|100|100¬String|String|String¬'+
...
CREATE OR ALTER PROCEDURE [dbo].[usplistarNC]
as
begin
select
...
CREATE OR ALTER PROCEDURE [dbo].[usplistarNCFecha]
@fechainicio date,
@fechafin date
as
begin
...
CREATE OR ALTER PROCEDURE [dbo].[usplistarOBS]
@Value varchar(max)
as
begin
Declare @p1 int,@p2 int,
...
CREATE OR ALTER PROCEDURE [dbo].[uspTemMonedas]
@Data varchar(max)
as
begin
...
CREATE OR ALTER PROCEDURE [dbo].[uspTraeGuiaCredito]    
@GuiaId varchar(40)    
as    
begin    
select     
...
CREATE OR ALTER PROCEDURE [dbo].[usptraerCaja]
@UsuarioId int
as
begin
select
...
CREATE OR ALTER PROCEDURE [dbo].[uspTraerPaginaActiva]
@UsuarioId int
as
begin
select
...
CREATE OR ALTER PROCEDURE [dbo].[uspTraerPorEntregar]
@NotaId varchar(40)
as
begin
select 
...
CREATE OR ALTER PROCEDURE [dbo].[uspUtilitario]
as
begin
select 
'TABLAS|TABLE['+
...
CREATE OR ALTER PROCEDURE [dbo].[validarDatos]
@NotaId numeric(38)
as
begin
...
/* Verificación mínima del paquete, sin consultar la base fuente. */
IF OBJECT_ID(N'dbo.DocumentoVentaCpeWeb', N'U') IS NULL OR OBJECT_ID(N'dbo.Indicador', N'U') IS NULL
    THROW 51000, 'Falta una tabla requerida después de la migración.', 1;
IF COL_LENGTH(N'dbo.Compania', N'FlagCaja') IS NULL OR COL_LENGTH(N'dbo.Producto', N'AplicaINV') IS NULL
