...
public interface ICompania
{
    ...
    Task<bool> ActualizarFlagCapturaAsync(int id, bool flagCaptura, CancellationToken cancellationToken = default);
    Task<bool> ActualizarConfiguracionCajaAsync(int id, bool flagCaja, string? correosAdmin, CancellationToken cancellationToken = default);
