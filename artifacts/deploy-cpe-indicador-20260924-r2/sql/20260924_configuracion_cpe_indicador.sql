...
(
    VALUES
        (N'CPE_USUARIO_SOL', CAST(c.CompaniaUserSecun AS varchar(500))),
        (N'CPE_CLAVE_SOL', CAST(c.ComapaniaPWD AS varchar(500))),
        (N'CPE_CERTIFICADO_PFX', CAST(c.CompaniaPFX AS varchar(500))),
        (N'CPE_CLAVE_CERTIFICADO', CAST(c.CompaniaClave AS varchar(500)))
