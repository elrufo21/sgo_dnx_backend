...
Al guardar el certificado desde Configuración > Facturación, el API crea `cpe-{CompaniaId}.pfx` o `.p12` en `CPE_PFX_DIRECTORY`. Si esa variable no existe, intenta usar `D:\CPE\FIRMABETA`. El Application Pool del API necesita permiso de modificación sobre esa carpeta.
