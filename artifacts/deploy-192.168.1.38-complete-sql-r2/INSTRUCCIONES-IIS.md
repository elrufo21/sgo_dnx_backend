...
4. El `api/appsettings.json` publicado usa autenticación SQL local. Verificar que la base `DXN_ICA2409` esté restaurada en la instancia predeterminada de SQL Server antes de iniciar el sitio.
